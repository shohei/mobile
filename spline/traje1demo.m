...
grid;vehi=[0,1,1,-1,-1,0;2,1,-1,-1,1,2];
[targetx1,targety1] = ginput(1);
hold on; plot(targetx1,targety1,'rp');
hold off;
[targetx2,targety2]=ginput(1);
hold on;
plot([targetx1,targetx2],[targety1,targety2],'-');
hold off;
...
%Path generation usign spline
%  Place virtual target points at the start and 
%  end points to determine the posture.
...
xlabel('[cm]');ylabel('[cm]');
axis equal; axis([-300,300,-100,500]);
grid; legend('Direction point','Spline');
